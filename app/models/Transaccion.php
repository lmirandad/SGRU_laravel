...
class Transaccion extends Eloquent implements UserInterface, RemindableInterface {
	...
	public function scopeBuscarTransaccionesPorSolicitud($query,$solicitud)
	{
		$query->join('estado_transaccion','estado_transaccion.idestado_transaccion','=','transaccion.idestado_transaccion')
			  ...
			  ->select('transaccion.*','estado_transaccion.nombre as nombre_estado_transaccion','herramienta.nombre as nombre_herramienta','denominacion_herramienta.nombre as nombre_denominacion','tipo_requerimiento.nombre as nombre_tipo_requerimiento','transaccion.nombre_punto_venta as nombre_punto_venta','entidad.nombre as nombre_entidad','canal.nombre as nombre_canal');
		return $query;
	}
	...
	public function scopeBuscarTransaccionesPorFechas($query,$fecha_desde,$fecha_hasta)
	{
		...
		$query->select('transaccion.*','estado_transaccion.nombre as nombre_estado_transaccion','herramienta.nombre as nombre_herramienta','denominacion_herramienta.nombre as nombre_denominacion','tipo_requerimiento.nombre as nombre_tipo_requerimiento','transaccion.nombre_punto_venta as nombre_punto_venta','entidad.nombre as nombre_entidad','canal.nombre as nombre_canal','solicitud.*','transaccion.fecha_inicio_procesando as fecha_inicio_procesando_transaccion');
