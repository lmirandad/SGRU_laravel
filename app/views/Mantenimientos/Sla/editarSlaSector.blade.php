...
<div class="main-content">
	<div class="container-fluid">
		<h3 class="page-title"><strong>EDITAR SLA</strong>&nbsp&nbsp&nbsp </h3>
				...
				<div class="panel panel-headline">
					...
					<div class="panel-body">
						...
						<div class="row">
							...
							{{ Form::text('fecha_inicio_vigencia', date('d-m-Y',strtotime($sla->fecha_inicio)),array('class'=>'form-control','placeholder'=>'Fecha de Nacimiento','disabled'=>'disabled')) }}
						</div>					
					</div>
				</div>
			</div>
		...
		{{ Form::open(array('url'=>'/slas/submit_editar_sla' ,'role'=>'form','id'=>'submit-editar')) }}
		{{ Form::hidden('idsla',$sla->idsla,array('id'=>'idsla'))}}
							...
							<div class="col-md-12">
								<div class="table-responsive">
									<table class="table table-hover"  >
										...
										<tbody >	
											@foreach($tipos_solicitudxsla as $index  => $accion)
											<tr class="">
												...
												<td class="text-nowrap" style=";width:20%">
													<input class="form-control" id="valor_sla_pendiente{{$index}}"  name='valor_sla_pendiente[]' value="{{$accion->sla_pendiente}}" />
												</td>
											</tr>
											@endforeach												
										</tbody>										
									...
									<table class="table table-hover">
										...
										<tbody >	
											...
											<tr class="">
												...
												<td class="text-nowrap" style=";width:20%">
													<input class="form-control" id="valor_sla_procesando{{$index}}" name='valor_sla_procesando[]' value="{{$accion->sla_procesando}}"/>
												</td>
											</tr>
											@endforeach	
										</tbody>										
		...
		<div class="row">
			<div class="form-group col-md-2  col-md-offset-8">				
				<a class="btn btn-info btn-block" id="btnEditarSla"> <i class="fa fa-floppy-o""></i> Actualizar</a>
			</div>
