...
<div class="main-content">
	<div class="container-fluid">
		<h3 class="page-title"><strong>CREACIÓN DE NUEVO SECTOR</strong></h3>
		...
		{{ Form::open(array('url'=>'/sectores/submit_crear_sector' ,'role'=>'form','id'=>'submit-crear')) }}
		<!-- OVERVIEW -->		
		<div class="row">
			<div class="col-md-12">
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="form-group col-md-3 @if($errors->first('nombre_sector')) has-error has-feedback @endif"">
								...
								{{ Form::text('nombre_sector',Input::old('nombre_sector'),array('class'=>'form-control','placeholder'=>'Ingrese nombre del sector')) }}
							</div>
		...
		<div class="row">
			<div class="form-group col-md-2  col-md-offset-8">				
				<a class="btn btn-info btn-block" id="btnCrearSector"> <i class="lnr lnr-plus-circle"></i> Crear</a>
			</div>
