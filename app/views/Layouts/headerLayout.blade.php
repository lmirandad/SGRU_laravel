...
<nav class="navbar navbar-default navbar-fixed-top">
	<div class="brand">
		@if($user->idrol == 1)
		<a href="{{URL::to('/principal_admin')}}"><img src="{{asset('assets/img/logo-sgru.png')}}" alt="SGRU" class="img-responsive logo" style="margin-bottom: -30px;margin-top: -20px;width:80%"	></a>
		@else		
		<a href="{{URL::to('/principal_gestor')}}"><img src="{{asset('assets/img/logo-sgru.png')}}" alt="SGRU" class="img-responsive logo" style="margin-bottom: -30px;margin-top: -20px;width:80%"	></a>
		@endif
	</div>
